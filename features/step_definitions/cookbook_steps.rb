...
Given 'a cookbook that has only a compiled metadata.json file' do
  write_file 'cookbooks/example/metadata.json', <<-EOF
    {
      "name": "foo",
      "description": "Installs/Configures foo",
      "long_description": "Installs/Configures foo",
      "maintainer": "Sparkly DevOps Princess Ninjas",
      "maintainer_email": "devops@princess-ninjas.com",
      "license": "FREEBEER",
      "platforms": {
  ...
  EOF
  system "find /Users/lamont/oc/foodcritic/tmp/aruba/cookbooks"
  #remove 'cookbooks/example/metadata.rb'
end
